...
function showGameOver(){
  ...
  COLORS.forEach(c=>{
    ...
    html+=`<div id="sc-row-${idx}" style="cursor:pointer;padding:var(--space-micro) 0" onclick="toggleScore(${idx})">
      <div class="r-line sc-row r-color-total" style="justify-content:center">
        ...
        <span style="min-width:calc(var(--card-h) * 1.15);text-align:center;padding:0 var(--space-micro)"><span class="color-dot" style="background:${chex[c]};width:var(--text-lg);height:var(--text-lg);display:inline-flex;align-items:center;justify-content:center;font-size:var(--text-sm);color:rgba(255,255,255,.6)">▼</span></span>
    ...
    html+=`<div id="sc-exp-${idx}" style="display:none;cursor:pointer;padding:var(--space-micro) 0" onclick="toggleScore(${idx})">
    ...
    html+=`<div id="sc-body-${idx}" style="display:none;padding:0 0 var(--space-micro)">`;
    ...
    html+=`<div class="r-line sc-row r-color-total" style="justify-content:center;padding-top:var(--space-micro)">
